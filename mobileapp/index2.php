...
<body>
	...
	<div class="screen" style="background-image: url('../images/green.png');">
		...
		<div class="row screen_row">
			...
			<div class="col-xs-4 col-md-4 screen_images">
				<img class="screen_image" style="margin-top:10%; max-height:80%;" src="../images/mobileapp2.png" />
			</div>
		</div>
	</div>
