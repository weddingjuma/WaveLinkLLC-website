			...
			<div class="row form-group">
			  <div class="col-md-4 col-xs-4">
				...
				<select name="category1">
					...
					<option value="hosting" <?php if($u["category1"] == "hosting") { echo 'selected'; } ?>>Hosting</option>
				</select>
			  </div>
			  <div class="col-md-4 col-xs-4">
				...
				<select name="category2">
					...
					<option value="hosting" <?php if($u["category2"] == "hosting") { echo 'selected'; } ?>>Hosting</option>
				</select>
			  </div>
			  <div class="col-md-4 col-xs-4">
				...
				<select name="category3">
					...
					<option value="hosting" <?php if($u["category3"] == "hosting") { echo 'selected'; } ?>>Hosting</option>
				</select>
			  </div>
			</div>
		  </fieldset>
