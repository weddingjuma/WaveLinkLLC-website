...
<head>
	...
	<title><?php echo $site_name ?> - Add/Edit Product</title>
	
	<link rel="stylesheet" href="https://sdk.ttcdn.co/tt-uikit-0.11.0.min.css">
	<link rel="stylesheet" type="text/css" href="http://<?php echo $_SERVER['SERVER_NAME']; ?>/flava/admin/css/jquery.datetimepicker.css">
</head>
<body>
		  ...
		  <fieldset>
			...
			<div class="row form-group">
			  <div class="col-md-6 col-xs-6">
				<label>Date</label>
				<input id="date" class="form-control" type="text" name="date" <?php echo 'value="'.htmlspecialchars($u["date"]).'"'; ?>>
			  </div>
			  <div class="col-md-6 col-xs-6">
				<label>Time</label>
				<input id="time" class="form-control" type="text" name="time" <?php echo 'value="'.htmlspecialchars($u["time"]).'"'; ?>>
			  </div>
			</div>
			-->
			<div class="row form-group">
	...
	<script src="http://<?php echo $_SERVER['SERVER_NAME']; ?>/flava/admin/js/jquery.datetimepicker.js"></script>
	<script>
