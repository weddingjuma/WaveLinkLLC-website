...
<head>
	...
	<title><?php echo $site_name ?> - Specials</title>
	...
	<div class="app-container" style="max-width:100%;">
		...
		<form class="form-inline row" method="post">
			<div class="col-xs-8 col-md-11">
				<?php 
					if($search == "") {
						echo "<input name=\"search\" type=\"search\" placeholder=\"Search specials\" class=\"form-control\">";
					} else {
						echo "<input name=\"search\" type=\"search\" placeholder=\"Search specials\" class=\"form-control\" value=\"".$search."\">";
					}
				?>
			</div>
		...
		<a href="edit.php" class="btn btn-default"><b>+</b> Add new special</a>
		...
		<table class="table table-striped">
			...
			<tbody>
				<?php
					$query = "SELECT * FROM `products` WHERE (category1 = 'special' OR category2 = 'special' OR category3 = 'special')";
					if($search <> "") {
						$search = "%".$search."%";
						$query = $query." AND ( 
