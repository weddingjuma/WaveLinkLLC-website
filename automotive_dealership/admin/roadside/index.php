<?php
	...
	$setting = get_settings($c, "SELECT * FROM settings WHERE page = 'roadside'");
?>
<!doctype html>
<html lang="en">
<head>
	...
	<title><?php echo $site_name ?> - Roadside Page</title>
		  ...
		  <fieldset>
			...
			<div class="row form-group">
			  ...
			  <div class="col-md-3 col-xs-6">
				...
				<input class="form-control" type="text" name="button_color" <?php echo 'value="'.$setting['button_color'].'"'; ?> required>
			  </div>
			</div>
			<div class="row form-group">
			  <div class="col-md-12 col-xs-12">
				<label>Prompt</label>
				<input class="form-control" type="text" name="prompt" <?php echo 'value="'.$setting['prompt'].'"'; ?> required>
			  </div>
			</div>
