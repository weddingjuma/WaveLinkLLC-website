	...
	<div class="app-container" style="max-width:100%;">
		...
		<form class="form-inline row" method="post">
			<div class="col-xs-8 col-md-11">
				<?php
					if($search == "") {
						echo "<input name=\"search\" type=\"search\" placeholder=\"Search pricing\" class=\"form-control\">";
					} else {
						echo "<input name=\"search\" type=\"search\" placeholder=\"Search pricing\" class=\"form-control\" value=\"".$search."\">";
					}
				?>
			</div>
		...
		<a href="edit.php" class="btn btn-default"><b>+</b> Add new pricing</a>
		...
		<table class="table table-striped">
			...
			<tbody>
				<?php
					$query = "SELECT * FROM `products` WHERE (category1 = 'event' OR category2 = 'event' OR category3 = 'event')";
					if($search <> "") {
						$search = "%".$search."%";
						$query = $query." AND (
