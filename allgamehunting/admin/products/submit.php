<?php
	...
	if($id == "") {
		if(mysqli_query($c, "insert into products(title, summary, description, date, time, quantity, price, sale_price, on_sale, featured, category1, category2, category3, image1, image2, image3, image4, image5, image6, image7, image8, type1, type2, type3, type4, type5, type6, type7, type8)
						values('$title', '$summary', '$description', '$date', '$time', '$quantity', '$price', '$sale_price', '$on_sale', '$featured', '$category1', '$category2', '$category3', '$filenames[0]', '$filenames[1]', '$filenames[2]', '$filenames[3]', '$filenames[4]', '$filenames[5]', '$filenames[6]', '$filenames[7]', '$type1', '$type2', '$type3', '$type4', '$type5', '$type6', '$type7', '$type8')")){
