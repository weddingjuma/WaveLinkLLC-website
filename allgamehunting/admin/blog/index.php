	...
	<div class="app-container" style="max-width:100%;">
		...
		<form class="form-inline row" method="post">
			<div class="col-xs-8 col-md-11">
				<?php
					if($search == "") {
						echo "<input name=\"search\" type=\"search\" placeholder=\"Search blog posts\" class=\"form-control\">";
					} else {
						echo "<input name=\"search\" type=\"search\" placeholder=\"Search blog posts\" class=\"form-control\" value=\"".$search."\">";
					}
				?>
			</div>
		...
		<a href="edit.php" class="btn btn-default"><b>+</b> Add new blog post</a>
			...
			<tbody>
				<?php
					...
					while($u = mysqli_fetch_array( $result, MYSQL_ASSOC )) {
						echo
						"<tr>
							<td><a href=\"http://".$_SERVER['SERVER_NAME']."/post/?id=".$u["id"]."\" target=\"_blank\">".$u["id"]."</a></td>
