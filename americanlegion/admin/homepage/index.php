	...
	<div class="app-container" style="max-width:100%;">
		...
		<form class="form-grouped" action="submit.php" method="post" enctype="multipart/form-data" data-validate>
		  <fieldset>
			...
			<div class="row form-group">
			  <div class="col-md-12 col-xs-12">
				<label>Pitch 1</label>
                <textarea class="form-control wysiwyg" name="slogan" id="slogan" rows="5"><?php echo $setting['slogan']; ?></textarea>
			  </div>
			</div>
			<div class="row form-group">
			  <div class="col-md-12 col-xs-12">
				<label>Pitch 2</label>
                <textarea class="form-control wysiwyg" name="pitch" id="pitch" rows="5"><?php echo $setting['pitch']; ?></textarea>
			  </div>
			</div>
		  </fieldset>
		  <fieldset>
		  ...
		  <fieldset>
			...
			<div class="row form-group">
			  <div class="col-md-3 col-xs-8">
				<label>1st Testimony Photo</label>
			...
			<div class="row form-group">
			  <div class="col-md-3 col-xs-8">
				<label>2nd Testimony Photo</label>
			...
			<div class="row form-group">
			  <div class="col-md-3 col-xs-8">
				<label>3rd Testimony Photo</label>
